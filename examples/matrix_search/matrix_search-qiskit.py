...
def Matrix_U():
    q_1 = qiskit.circuit.QuantumRegister(3, "q_1")
    q_2 = qiskit.circuit.QuantumRegister(3, "q_2")
...
def Matrix():
    c_1 = qiskit.circuit.ClassicalRegister(3, "c_1")
    c_2 = qiskit.circuit.ClassicalRegister(3, "c_2")
...
def IsEntryZero_U():
    i0 = qiskit.circuit.QuantumRegister(3, "i0")
    j0 = qiskit.circuit.QuantumRegister(3, "j0")
...
def IsEntryZero():
    i0 = qiskit.circuit.ClassicalRegister(3, "i0")
    j0 = qiskit.circuit.ClassicalRegister(3, "j0")
...
# UAny[Fin 6, 3.737551674300331e-8]
def UAny():
    i = qiskit.circuit.QuantumRegister(3, "i")
    ret = qiskit.circuit.QuantumRegister(1, "ret")
    s_result = qiskit.circuit.QuantumRegister(3, "s_result")
    ...
    ctrl = qiskit.circuit.QuantumRegister(35, "ctrl")
    pred_out = qiskit.circuit.QuantumRegister(35, "pred_out")
    n_iter = qiskit.circuit.QuantumRegister(35, "n_iter")
    s_arg = qiskit.circuit.QuantumRegister(105, "s_arg")
    ...
    qc.append(
        qiskit.circuit.Gate(
            "RevEmbedU [a] (UnOpE {un_op = AnyOp, operand = VarE {var = a}})", 36, []
        ),
        [*pred_out, *ret],
    )
    qc.append(
...
def IsRowAllOnes_U():
    ...
    n_iter = qiskit.circuit.QuantumRegister(35, "n_iter")
    s_arg = qiskit.circuit.QuantumRegister(105, "s_arg")
    aux_prim = qiskit.circuit.QuantumRegister(3, "aux_prim")
    ...
    aux_prim_5 = qiskit.circuit.QuantumRegister(35, "aux_prim_5")
    aux_prim_6 = qiskit.circuit.QuantumRegister(35, "aux_prim_6")
    aux_prim_7 = qiskit.circuit.QuantumRegister(35, "aux_prim_7")
    aux_prim_8 = qiskit.circuit.QuantumRegister(105, "aux_prim_8")
...
def Grover():
    ...
    qc.append(qiskit.circuit.Gate("DistrU (UniformE {sample_ty = Fin 6})", 3, []), [*x])
...
def QAny():
    i = qiskit.circuit.ClassicalRegister(3, "i")
    ret_1 = qiskit.circuit.ClassicalRegister(1, "ret_1")
    s_result_1 = qiskit.circuit.ClassicalRegister(3, "s_result_1")
    ...
    for _ in range(16):
        Q_sum = 0
        for j_lim in [1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]:
...
def UAny_1():
    ...
    s_result_2 = qiskit.circuit.QuantumRegister(3, "s_result_2")
    aux_7 = qiskit.circuit.QuantumRegister(1, "aux_7")
    aux_8 = qiskit.circuit.QuantumRegister(1, "aux_8")
    aux_9 = qiskit.circuit.QuantumRegister(3, "aux_9")
    ...
    aux_14 = qiskit.circuit.QuantumRegister(35, "aux_14")
    aux_15 = qiskit.circuit.QuantumRegister(35, "aux_15")
    aux_16 = qiskit.circuit.QuantumRegister(35, "aux_16")
    aux_17 = qiskit.circuit.QuantumRegister(105, "aux_17")
    aux_18 = qiskit.circuit.QuantumRegister(3, "aux_18")
    ...
    aux_23 = qiskit.circuit.QuantumRegister(35, "aux_23")
    aux_24 = qiskit.circuit.QuantumRegister(35, "aux_24")
    aux_25 = qiskit.circuit.QuantumRegister(35, "aux_25")
    aux_26 = qiskit.circuit.QuantumRegister(105, "aux_26")
    aux_27 = qiskit.circuit.QuantumRegister(1, "aux_27")
    aux_28 = qiskit.circuit.QuantumRegister(1, "aux_28")
    ctrl_1 = qiskit.circuit.QuantumRegister(7, "ctrl_1")
    pred_out_1 = qiskit.circuit.QuantumRegister(7, "pred_out_1")
    n_iter_1 = qiskit.circuit.QuantumRegister(7, "n_iter_1")
    s_arg_1 = qiskit.circuit.QuantumRegister(21, "s_arg_1")
    qc = qiskit.circuit.QuantumCircuit(
        ret_2,
        s_result_2,
        aux_7,
    ...
    qc.append(
        qiskit.circuit.Gate(
            "RevEmbedU [a] (UnOpE {un_op = AnyOp, operand = VarE {var = a}})", 8, []
        ),
        [*pred_out_1, *ret_2],
    )
    qc.append(
...
def HasAllOnesRow_U():
    ...
    aux_prim_17 = qiskit.circuit.QuantumRegister(35, "aux_prim_17")
    aux_prim_18 = qiskit.circuit.QuantumRegister(35, "aux_prim_18")
    aux_prim_19 = qiskit.circuit.QuantumRegister(35, "aux_prim_19")
    aux_prim_20 = qiskit.circuit.QuantumRegister(105, "aux_prim_20")
    ...
    aux_prim_26 = qiskit.circuit.QuantumRegister(35, "aux_prim_26")
    aux_prim_27 = qiskit.circuit.QuantumRegister(35, "aux_prim_27")
    aux_prim_28 = qiskit.circuit.QuantumRegister(35, "aux_prim_28")
    aux_prim_29 = qiskit.circuit.QuantumRegister(105, "aux_prim_29")
    aux_prim_30 = qiskit.circuit.QuantumRegister(1, "aux_prim_30")
    aux_prim_31 = qiskit.circuit.QuantumRegister(1, "aux_prim_31")
    aux_prim_32 = qiskit.circuit.QuantumRegister(7, "aux_prim_32")
    aux_prim_33 = qiskit.circuit.QuantumRegister(7, "aux_prim_33")
    aux_prim_34 = qiskit.circuit.QuantumRegister(7, "aux_prim_34")
    aux_prim_35 = qiskit.circuit.QuantumRegister(21, "aux_prim_35")
    qc = qiskit.circuit.QuantumCircuit(
        ok,
        ok_1,
        s_result_2,
...
def Grover_1():
    ...
    aux_31 = qiskit.circuit.QuantumRegister(3, "aux_31")
    ...
    aux_36 = qiskit.circuit.QuantumRegister(35, "aux_36")
    aux_37 = qiskit.circuit.QuantumRegister(35, "aux_37")
    aux_38 = qiskit.circuit.QuantumRegister(35, "aux_38")
    aux_39 = qiskit.circuit.QuantumRegister(105, "aux_39")
    aux_40 = qiskit.circuit.QuantumRegister(3, "aux_40")
    ...
    aux_45 = qiskit.circuit.QuantumRegister(35, "aux_45")
    aux_46 = qiskit.circuit.QuantumRegister(35, "aux_46")
    aux_47 = qiskit.circuit.QuantumRegister(35, "aux_47")
    aux_48 = qiskit.circuit.QuantumRegister(105, "aux_48")
    ...
    qc.append(
        qiskit.circuit.Gate("DistrU (UniformE {sample_ty = Fin 6})", 3, []), [*x_1]
    )
    qc.append(qiskit.circuit.Gate("URepeatS", qc.num_qubits, []), qc.qubits)
    qc.append(qiskit.circuit.Gate("BasicGateU HGate", 1, []), [*ret_3])
    qc.append(qiskit.circuit.Gate("BasicGateU XGate", 1, []), [*ret_3])
...
def QAny_1():
    ...
    s_result_3 = qiskit.circuit.ClassicalRegister(3, "s_result_3")
    not_done_1 = qiskit.circuit.ClassicalRegister(1, "not_done_1")
    Q_sum_1 = qiskit.circuit.ClassicalRegister(5, "Q_sum_1")
    j_1 = qiskit.circuit.ClassicalRegister(5, "j_1")
    j_lim_1 = qiskit.circuit.ClassicalRegister(5, "j_lim_1")
    qc = qiskit.circuit.QuantumCircuit(
        ret_3, s_result_3, not_done_1, Q_sum_1, j_1, j_lim_1, name="QAny_1"
    )
    for _ in range(3):
        Q_sum_1 = 0
        for j_lim_1 in [1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]:
