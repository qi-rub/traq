      ...
      , mbody =
          Just
            FunBody
              ...
              , body_stmt =
                  SeqS
                    [ ExprS{rets = [ok], expr = FunCallE{fun_kind = PrimitiveCall (QAny $ qAnyCFNW "IsEntryZero"), args = [i]}}
    ...
    FunDef
      ...
      , mbody =
          Just
            FunBody
              { param_names = []
              , body_stmt = ExprS{rets = [ok], expr = FunCallE{fun_kind = PrimitiveCall (QAny $ qAnyCFNW "IsRowAllOnes"), args = []}}
              , ret_names = [ok]
              }
      , ret_types = [tyBool]
      }
